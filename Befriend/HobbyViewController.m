...
- (void)viewDidLoad
{
    ...
    namesArray = [NSArray arrayWithObjects:@"Sports", @"Clubbing", @"General", @"Gaming", @"Wingman", @"Shopping", @"Cinema", @"Gigs", @"Playdate", nil];

    currSelection = [NSMutableArray arrayWithArray:self.meInfo[@"Hobby"]];
}
...
{
    self.meInfo[@"Hobby"] = currSelection;
    [self.navigationController popViewControllerAnimated:YES];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (realIndex < namesArray.count) {
        ...
        cell.firstIconView.image = [UIImage imageNamed:[NSString stringWithFormat:@"hob%d.png", realIndex]];
    ...
    if (realIndex < namesArray.count) {
        ...
        cell.secondIconView.image = [UIImage imageNamed:[NSString stringWithFormat:@"hob%d.png", realIndex]];
    ...
    if (realIndex < namesArray.count) {
        ...
        cell.thirdIconView.image = [UIImage imageNamed:[NSString stringWithFormat:@"hob%d.png", realIndex]];
