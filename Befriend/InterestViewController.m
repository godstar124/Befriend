...
- (void)viewDidLoad
{
    ...
    if (!self.isNotFirst) {
        ...
        [button setImage:[UIImage imageNamed:@"itemSport.png"] forState:UIControlStateNormal];
        [button addTarget:self action:@selector(clickSport) forControlEvents:UIControlEventTouchUpInside];
        UIBarButtonItem *rightItem = [[UIBarButtonItem alloc] initWithCustomView:button];
        self.navigationItem.rightBarButtonItem = rightItem;
    }
    
    namesArray = [NSArray arrayWithObjects:@"Dining Out", @"Films", @"Travel/Sightseeing", @"Music", @"Coffee/Conversation", @"The Outdoors", @"Cooking", @"Dancing", @"Television", @"Museum/Exhibits", @"Gardening", @"Writing", @"Playing Sports", @"Book Club", @"Theatre", @"Astrology", @"Singing", @"Playing Instrument", @"Camping", @"Cars", @"Computers", @"Drawing", @"Fishing/Hunting", @"Hobbies & Crafts", @"Internet", @"Others", @"Performing Arts", @"Photography", @"Playing Cards", @"Political Interests", @"Religion", @"Spiritual", @"Shopping", @"Antiques", @"Video Games", @"Wine Tasting", @"Volunteering", @"Watching Sports", @"Business Networking", @"University Friends", nil];
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    selectionArray = [AppDelegate sharedAppDelegate].currUser[@"INTEREST"];
...
- (void)clickSport
{
    [AppDelegate sharedAppDelegate].currUser[@"INTEREST"] = selectionArray;
    [self performSegueWithIdentifier:@"ShowSportsView" sender:nil];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (realIndex < namesArray.count) {
        ...
        cell.firstIconView.image = [UIImage imageNamed:[NSString stringWithFormat:@"int%d.png", realIndex]];
    ...
    if (realIndex < namesArray.count) {
        ...
        cell.secondIconView.image = [UIImage imageNamed:[NSString stringWithFormat:@"int%d.png", realIndex]];
    ...
    if (realIndex < namesArray.count) {
        ...
        cell.thirdIconView.image = [UIImage imageNamed:[NSString stringWithFormat:@"int%d.png", realIndex]];
